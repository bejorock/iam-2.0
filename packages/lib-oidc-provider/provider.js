...
class Provider extends events.EventEmitter {
  constructor(issuer, setup = {}) {
    ...
    instance(this).Server = setup.server
  ...
  //get Adapter() { return instance(this).Adapter }
  get Server() { return instance(this).Server }

  clientAdd(metadata, dynamic) {
    return instance(this).clientAdd(metadata, dynamic)
  }

  clientRemove(id) {
    return instance(this).clientRemove(id)
  }
